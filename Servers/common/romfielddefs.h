...
static const unsigned int MAXFIELDS = 80;
...
static const int CSV_ROMCANCEL      = 39;       //true when cancel is not unsolicited cancel
static const int CSV_NBBO           = 39;       //option NBBO provided by client for price checking.
...
static const int CSV_PRODUCTID		=	56		;

static const int CSV_EXEC_INSTRUCTION=	57		;// Fix ExecInst;
static const int CSV_SHORT_LENDER	=	58;
//static const int CSV_ACTTAG			=	59;
static const int CSV_OATS_INSTRUCTION = 59;     //used to resolve collision between CSV_ORDER_TAG
                                                //and CSV_INSTRUCTION between ROM and OATS.
...
static const int CSV_MAX_ORDERS             = 13;
static const int CSV_CURRENT_OPENORDERS     = 14;
static const int CSV_MAX_TOTALSHARES        = 15;
static const int CSV_CURRENT_OPENSHARES     = 16;
static const int CSV_MAX_TOTALDOLLARS       = 17;
static const int CSV_CURRENT_DOLLARS        = 18;
static const int CSV_MAX_SHARESPERORDER     = 19;
static const int CSV_MAX_DOLLARSPERORDER    = 20;
static const int CSV_ADMIN_INSTANCES        = 21;
static const int CSV_MSGRATE_LIMIT          = 22;
static const int CSV_FUTURE_PRODUCTS        = 23;
static const int CSV_SYMBOL_FREAK           = 24;
static const int CSV_LENDING_GROUP          = 25;
...
//the following fields are defined for Admin commands related to position management
static const int CSV_POS_INIT_POSITION  = 3;
static const int CSV_POS_CURRENT_POSITION   = 4;
...
static const int CSV_POS_CLR = 1;
static const int CSV_POS_SYMBOL = 3;
static const int CSV_POS_POS = 4;
static const int CSV_POS_INIT_POS = 5;
static const int CSV_POS_POSCHANGE  = 8;
static const int CSV_RDS_MSG_TIME = 11;
static const int CSV_CLRSTOGRP      = 9;
static const int CSV_POS_CLRACCT    = 10;

static const int CSV_LENDINGGROUP = 1;
static const int CSV_LENDINGGROUP_LIMIT = 5;
static const int CSV_LENDINGGROUP_BALANCE = 4;

static const int CSV_LENDING_CLR = 1;
static const int CSV_LENDING_CLR_LIMIT = 5;
static const int CSV_LENDING_CLR_BALANCE = 4;

static const int CSV_EASYBORROW_ACTION    = 4;
