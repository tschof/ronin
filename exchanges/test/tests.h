...
DECLARE_TEST(test_reset_calculator)
    ...
    DECLARE_TEST(test_fixmsg_addstr)
    DECLARE_TEST(test_fixmsg_attach)
    ...
    DECLARE_TEST(test_itoa)
    DECLARE_TEST(test_allocate_master)
    DECLARE_TEST(test_token_up)
    DECLARE_TEST(test_r2f_spread_life_cycle4)
    DECLARE_TEST(test_r2f_spread_life_cycle3)
    DECLARE_TEST(test_r2f_spread_life_cycle2)
    DECLARE_TEST(test_symbol_killer)
    DECLARE_TEST(test_time_t_convert)
    DECLARE_TEST(test_make_long)
    DECLARE_TEST(test_last_logon_logic)
    DECLARE_TEST(test_realloc_receive)
    DECLARE_TEST(test_resend)
#endif                          //__TESTS_H__
