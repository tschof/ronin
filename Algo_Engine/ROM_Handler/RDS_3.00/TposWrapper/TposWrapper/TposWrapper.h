...
namespace TposWrapper
{
	...
	public:
	    ...
	    String^		ExerType;
	    String^		InstrumentId;
	    String^		UndInstrumentId;
	    String^		longName;
	    String^		ObsoleteDateTime;
	    String^		UndExpirationDate;
	    String^		fullSymbol;
	    String^		IssueDate;
	    String^		InrstAccuralDate;
	...
	public:
		...
		int GetSecurityByInstID(String^ id, SecurityDesc^ out);
	    ...
	    String^ GetPortfolioName( String^ symbol );
	    String^ GetPortfolioSymbol( String^ name );
		...
		void  SubscribePositions(String^ grp, String^ pf, String^ trader,  TposPositionCallback^ cb);
		void  UnsubscribePositions(String^ grp, String^ pf, String^ trader);
		void  SubscribePrices(String^ name, String^ date,  TposPriceCallback^ cb);

		String^ RtrvTrades(String^ user, String^ grp, String^ pf, String^ trader, String^ bDate, String^ bTime, bool filterUser, ArrayList^ out);
