...
# ADD LINK32 FixMsg42-r.lib ombase-dynamic-r-can.lib DBOLib.lib libct.lib libcs.lib version.lib threadpool.lib OrderTypeValidator.lib DatabaseSettings.lib /nologo /subsystem:windows /machine:I386 /out:"..\..\..\Bin\MERRILL.exe" /libpath:"..\..\..\Lib"
...
# ADD LINK32 FixMsg42-d.lib ombase-dynamic-d-can.lib version.lib DBOLib.lib libct.lib libcs.lib threadpool.lib OrderTypeValidatorD.lib DatabaseSettingsD.lib /nologo /subsystem:windows /debug /machine:I386 /out:"..\..\..\Bin\MERRILLD.exe" /pdbtype:sept /libpath:"..\..\..\Bin"
