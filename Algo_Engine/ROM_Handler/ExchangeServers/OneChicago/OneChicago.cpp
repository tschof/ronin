// OneChicago.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(COneChicagoApp, CWinApp)
	//{{AFX_MSG_MAP(COneChicagoApp)
...
/////////////////////////////////////////////////////////////////////////////
// COneChicagoApp construction

COneChicagoApp::COneChicagoApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// The one and only COneChicagoApp object

COneChicagoApp theApp;

/////////////////////////////////////////////////////////////////////////////
// COneChicagoApp initialization

BOOL COneChicagoApp::InitInstance()
{
	if (!AfxSocketInit())
	{
	...
	pDocTemplate = new CMultiDocTemplate(
		IDR_OCTYPE,
		RUNTIME_CLASS(COneChicagoDoc),
		RUNTIME_CLASS(CChildFrame), // custom MDI child frame
		RUNTIME_CLASS(COneChicagoView));
...
//		return FALSE;
	...
	*/
	...
	pDoc = (COneChicagoDoc *)pDocTemplate->CreateNewDocument();
	...
	{
  		m_pClientView = (COneChicagoView *)pDoc->GetNextView(pos);
	...
	if ((pos = pDoc->GetFirstViewPosition()))
	{
  		m_pExchangeView = (COneChicagoView *)pDoc->GetNextView(pos);
...
*/
	...
	m_pHandler	= new COneChicagoHandler();								// create order handler
	try {
		m_pExchange	= new COneChicagoFixSession();								// create fix session
	}
	catch(CFixSessionException&) {
		ProcessErrorEx(MODE_ERR_NOTIFY,"OneChicago App", "Initialization of FIX session failed.");
		return FALSE;
	}
...
void COneChicagoApp::UpdateClients()
{
	if (m_pClientView)
...
void COneChicagoApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
