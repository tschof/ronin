// ATDHandler.h: interface for the CATDHandler class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_ATDHANDLER_H__0BAB0042_9751_4E87_9B36_226FC8D4FCC7__INCLUDED_)
#define AFX_ATDHANDLER_H__0BAB0042_9751_4E87_9B36_226FC8D4FCC7__INCLUDED_
...
class CATDHandler : public CExchangeHandler
{
public:
	CATDHandler();
	virtual ~CATDHandler()
...
protected:
	...
	{
		#if defined _ATDV
			CString Msg("AH:OPR:ATDV doesn't support cancel replace.");
			throw Msg;
		#endif
	...
	inline virtual CString& GetNewOrdTagString(long SeqNum)
	{
		...
		OrdTag.Format("%sTD%0.5d", CTime::GetCurrentTime().Format("%Y%m%d"),SeqNum);
		return OrdTag;
	}
...
#endif // !defined(AFX_ATDHANDLER_H__0BAB0042_9751_4E87_9B36_226FC8D4FCC7__INCLUDED_)
