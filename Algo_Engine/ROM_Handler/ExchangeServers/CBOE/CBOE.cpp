// CBOE.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CCBOEApp, CWinApp)
	//{{AFX_MSG_MAP(CCBOEApp)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CCBOEApp object

CCBOEApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CCBOEApp initialization

BOOL CCBOEApp::InitInstance()
{
	if (!AfxSocketInit())
	{
	...
	pDocTemplate = new CMultiDocTemplate(
		IDR_CBOETYPE,
		RUNTIME_CLASS(CCBOEDoc),
		RUNTIME_CLASS(CChildFrame), // custom MDI child frame
		RUNTIME_CLASS(CCBOEView));
...
//		return FALSE;
	...
	pDoc = (CCBOEDoc *)pDocTemplate->CreateNewDocument();
	...
	{
  		m_pClientView = (CCBOEView *)pDoc->GetNextView(pos);
	...
	if ((pos = pDoc->GetFirstViewPosition()))
	{
  		m_pExchangeView = (CCBOEView *)pDoc->GetNextView(pos);
...
*/
	...
	m_pHandler	= new CCBOEHandler();								// create order handler
	try {
		m_pExchange	= new CCBOEFixSession();								// create fix session
	}
	catch(CFixSessionException&) {
		ProcessErrorEx(MODE_ERR_NOTIFY,"CBOE App", "Initialization of FIX session failed.");
		return FALSE;
	}
