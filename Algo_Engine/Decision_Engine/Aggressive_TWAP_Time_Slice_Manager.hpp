#ifndef __AGGRESSIVE_TWAP_TIME_SLICE_MANAGER_HPP__
#define __AGGRESSIVE_TWAP_TIME_SLICE_MANAGER_HPP__

#include "TWAP_Time_Slice_Manager.hpp"

namespace dart
{
  class Aggressive_TWAP_Time_Slice_Manager
    : public TWAP_Time_Slice_Manager
  {
  public:
    Aggressive_TWAP_Time_Slice_Manager
      (dart::TWAP_Order*,
