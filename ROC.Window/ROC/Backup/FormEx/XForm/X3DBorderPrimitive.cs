	...
	public class X3DBorderPrimitive
	{
		...
		public GraphicsPath FindX3DBorderPrimitive(Rectangle rcBorder)
		{
			switch (m_eBorderType)
			{
				case XBorderType.Rounded:
					m_BorderShape = XWidnowHelper.RoundRect((RectangleF)rcBorder, m_lRadius, m_lRadius, 0, 0);
					break;
			...
			)
		{
			...
			if (bFlat)
			{
				...
				{
					case XBorderType.Rectangular:
						XBorderPath = XWidnowHelper.RoundRect((RectangleF)rcBorder, lC, lC, lC, lC);
						break;
					case XBorderType.Rounded:
						XBorderPath = XWidnowHelper.RoundRect((RectangleF)rcBorder, lC, lC, 0, 0);
						break;
					case XBorderType.Inclinated:
