namespace ROC
{
	partial class frmFutureTicket
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmFutureTicket));
			...
			DataGridViewEx.DGVBasePrinter dgvBasePrinter3 = new DataGridViewEx.DGVBasePrinter();
			...
			this.panelManagerFuture = new PanelEx.PanelManager();
			this.managedPanelBook = new PanelEx.ManagedPanel();
			this.splitContainerBooks = new System.Windows.Forms.SplitContainer();
			this.rocBookListBid = new DataGridViewEx.ROCBookList();
			this.rocBookListAsk = new DataGridViewEx.ROCBookList();
			this.managedPanelSSF = new PanelEx.ManagedPanel();
			this.rocSSFList = new DataGridViewEx.ROCSSFList();
			...
			this.panelManagerFuture.SuspendLayout();
			this.managedPanelBook.SuspendLayout();
			this.splitContainerBooks.Panel1.SuspendLayout();
			this.splitContainerBooks.Panel2.SuspendLayout();
			this.splitContainerBooks.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.rocBookListBid)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.rocBookListAsk)).BeginInit();
			this.managedPanelSSF.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.rocSSFList)).BeginInit();
			this.SuspendLayout();
			// 
			// CaptionBar
			// 
			...
			this.dspStopPrice.MouseEnter += new System.EventHandler(this.dspStopPrice_MouseEnter);
			// 
			...
			this.dspLimitPrice.Location = new System.Drawing.Point(2, 18);
			...
			this.dspLimitPrice.MouseEnter += new System.EventHandler(this.dspLimitPrice_MouseEnter);
			// 
			...
			this.panelCommands.MinimumSize = new System.Drawing.Size(361, 24);
			...
			this.cmdSell.MinimumSize = new System.Drawing.Size(118, 20);
			...
			this.cmdBuy.MinimumSize = new System.Drawing.Size(118, 20);
			...
			// panelManagerFuture
			// 
			this.panelManagerFuture.Controls.Add(this.managedPanelBook);
			this.panelManagerFuture.Controls.Add(this.managedPanelSSF);
			this.panelManagerFuture.Dock = System.Windows.Forms.DockStyle.Fill;
			this.panelManagerFuture.Location = new System.Drawing.Point(0, 224);
			this.panelManagerFuture.Name = "panelManagerFuture";
			this.panelManagerFuture.Padding = new System.Windows.Forms.Padding(2);
			this.panelManagerFuture.SelectedIndex = 0;
			this.panelManagerFuture.SelectedPanel = this.managedPanelBook;
			this.panelManagerFuture.Size = new System.Drawing.Size(362, 222);
			this.panelManagerFuture.TabIndex = 0;
			this.panelManagerFuture.TabStop = false;
			// 
			// managedPanelBook
			// 
			this.managedPanelBook.BackColor = System.Drawing.Color.LightSteelBlue;
			this.managedPanelBook.Controls.Add(this.splitContainerBooks);
			...
			this.managedPanelBook.Size = new System.Drawing.Size(362, 222);
			this.managedPanelBook.Text = "managedPanelBook";
			// 
			// splitContainerBooks
			// 
			this.splitContainerBooks.Dock = System.Windows.Forms.DockStyle.Fill;
			this.splitContainerBooks.Location = new System.Drawing.Point(2, 2);
			this.splitContainerBooks.Name = "splitContainerBooks";
			// 
			// splitContainerBooks.Panel1
			// 
			this.splitContainerBooks.Panel1.Controls.Add(this.rocBookListBid);
			// 
			// splitContainerBooks.Panel2
			// 
			this.splitContainerBooks.Panel2.Controls.Add(this.rocBookListAsk);
			this.splitContainerBooks.Size = new System.Drawing.Size(358, 218);
			this.splitContainerBooks.SplitterDistance = 178;
			this.splitContainerBooks.SplitterWidth = 3;
			this.splitContainerBooks.TabIndex = 0;
			this.splitContainerBooks.TabStop = false;
			// 
			// rocBookListBid
			// 
			this.rocBookListBid.AskColor = System.Drawing.Color.Red;
			this.rocBookListBid.BidColor = System.Drawing.Color.LimeGreen;
			this.rocBookListBid.BlueDefault = 228;
			this.rocBookListBid.ColorShiftInterval = 18;
			this.rocBookListBid.ColorShiftIntervalMax = 7;
			this.rocBookListBid.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			new BindingListEx.ROCBindingList<string>().Add("");
			this.rocBookListBid.DisplayFactors = ((System.Collections.Generic.Dictionary<string, double>)(resources.GetObject("rocBookListBid.DisplayFactors")));
			this.rocBookListBid.Dock = System.Windows.Forms.DockStyle.Fill;
			this.rocBookListBid.GreenDefault = 243;
			this.rocBookListBid.GridKeys = ((System.Collections.Generic.List<string>)(resources.GetObject("rocBookListBid.GridKeys")));
			this.rocBookListBid.HeaderBackColor = System.Drawing.Color.FromArgb(((int)(((byte)(233)))), ((int)(((byte)(243)))), ((int)(((byte)(228)))));
			this.rocBookListBid.Importing = false;
			this.rocBookListBid.LastFilter = "";
			this.rocBookListBid.LastSort = "";
			this.rocBookListBid.Location = new System.Drawing.Point(0, 0);
			this.rocBookListBid.Name = "rocBookListBid";
			this.rocBookListBid.PriceBook = 0;
			this.rocBookListBid.PriceSelected = false;
			...
			dgvBasePrinter1.TitleFormatFlags = ((System.Drawing.StringFormatFlags)(((System.Drawing.StringFormatFlags.NoWrap | System.Drawing.StringFormatFlags.LineLimit)
						| System.Drawing.StringFormatFlags.NoClip)));
			this.rocBookListBid.Printer = dgvBasePrinter1;
			this.rocBookListBid.Processing = false;
			this.rocBookListBid.RedDefault = 233;
			this.rocBookListBid.RefreshAggragation = true;
			this.rocBookListBid.RefreshSharedRows = false;
			this.rocBookListBid.RocGridTable = null;
			this.rocBookListBid.SelectedForeColor = System.Drawing.Color.LightBlue;
			this.rocBookListBid.ShouldScrollToLastRow = false;
			this.rocBookListBid.ShowOrderID = "";
			this.rocBookListBid.ShowOrderMenu = false;
			this.rocBookListBid.ShowTip = "";
			this.rocBookListBid.ShowToolTip = false;
			this.rocBookListBid.Size = new System.Drawing.Size(178, 218);
			this.rocBookListBid.SizeBook = ((long)(0));
			this.rocBookListBid.SizeSelected = false;
			new BindingListEx.ROCBindingList<string>().Add("");
			this.rocBookListBid.TabIndex = 0;
			this.rocBookListBid.TabStop = false;
			this.rocBookListBid.TickSizes = ((System.Collections.Generic.Dictionary<string, double>)(resources.GetObject("rocBookListBid.TickSizes")));
			// 
			// rocBookListAsk
			// 
			this.rocBookListAsk.AskColor = System.Drawing.Color.Red;
			this.rocBookListAsk.BidColor = System.Drawing.Color.LimeGreen;
			this.rocBookListAsk.BlueDefault = 228;
			this.rocBookListAsk.ColorShiftInterval = 18;
			this.rocBookListAsk.ColorShiftIntervalMax = 7;
			this.rocBookListAsk.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			new BindingListEx.ROCBindingList<string>().Add("");
			this.rocBookListAsk.DisplayFactors = ((System.Collections.Generic.Dictionary<string, double>)(resources.GetObject("rocBookListAsk.DisplayFactors")));
			this.rocBookListAsk.Dock = System.Windows.Forms.DockStyle.Fill;
			this.rocBookListAsk.GreenDefault = 243;
			this.rocBookListAsk.GridKeys = ((System.Collections.Generic.List<string>)(resources.GetObject("rocBookListAsk.GridKeys")));
			this.rocBookListAsk.HeaderBackColor = System.Drawing.Color.FromArgb(((int)(((byte)(233)))), ((int)(((byte)(243)))), ((int)(((byte)(228)))));
			this.rocBookListAsk.Importing = false;
			this.rocBookListAsk.LastFilter = "";
			this.rocBookListAsk.LastSort = "";
			this.rocBookListAsk.Location = new System.Drawing.Point(0, 0);
			this.rocBookListAsk.Name = "rocBookListAsk";
			this.rocBookListAsk.PriceBook = 0;
			this.rocBookListAsk.PriceSelected = false;
			...
			dgvBasePrinter2.TitleFormatFlags = ((System.Drawing.StringFormatFlags)(((System.Drawing.StringFormatFlags.NoWrap | System.Drawing.StringFormatFlags.LineLimit)
						| System.Drawing.StringFormatFlags.NoClip)));
			this.rocBookListAsk.Printer = dgvBasePrinter2;
			this.rocBookListAsk.Processing = false;
			this.rocBookListAsk.RedDefault = 233;
			this.rocBookListAsk.RefreshAggragation = true;
			this.rocBookListAsk.RefreshSharedRows = false;
			this.rocBookListAsk.RocGridTable = null;
			this.rocBookListAsk.SelectedForeColor = System.Drawing.Color.LightBlue;
			this.rocBookListAsk.ShouldScrollToLastRow = false;
			this.rocBookListAsk.ShowOrderID = "";
			this.rocBookListAsk.ShowOrderMenu = false;
			this.rocBookListAsk.ShowTip = "";
			this.rocBookListAsk.ShowToolTip = false;
			this.rocBookListAsk.Size = new System.Drawing.Size(177, 218);
			this.rocBookListAsk.SizeBook = ((long)(0));
			this.rocBookListAsk.SizeSelected = false;
			new BindingListEx.ROCBindingList<string>().Add("");
			this.rocBookListAsk.TabIndex = 0;
			this.rocBookListAsk.TabStop = false;
			this.rocBookListAsk.TickSizes = ((System.Collections.Generic.Dictionary<string, double>)(resources.GetObject("rocBookListAsk.TickSizes")));
			// 
			// managedPanelSSF
			// 
			this.managedPanelSSF.BackColor = System.Drawing.Color.LightSteelBlue;
			this.managedPanelSSF.Controls.Add(this.rocSSFList);
			this.managedPanelSSF.Location = new System.Drawing.Point(0, 0);
			this.managedPanelSSF.Name = "managedPanelSSF";
			this.managedPanelSSF.Size = new System.Drawing.Size(0, 0);
			this.managedPanelSSF.Text = "managedPanelSSF";
			// 
			// rocSSFList
			// 
			this.rocSSFList.BlueDefault = 228;
			this.rocSSFList.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			new BindingListEx.ROCBindingList<string>().Add("");
			this.rocSSFList.DisplayFactors = ((System.Collections.Generic.Dictionary<string, double>)(resources.GetObject("rocSSFList.DisplayFactors")));
			this.rocSSFList.Dock = System.Windows.Forms.DockStyle.Fill;
			this.rocSSFList.ExpirationSSF = "";
			this.rocSSFList.GreenDefault = 243;
			this.rocSSFList.GridKeys = ((System.Collections.Generic.List<string>)(resources.GetObject("rocSSFList.GridKeys")));
			this.rocSSFList.HeaderBackColor = System.Drawing.Color.FromArgb(((int)(((byte)(233)))), ((int)(((byte)(243)))), ((int)(((byte)(228)))));
			this.rocSSFList.Importing = false;
			this.rocSSFList.LastFilter = "";
			this.rocSSFList.LastSort = "Expiration";
			this.rocSSFList.Location = new System.Drawing.Point(0, 0);
			this.rocSSFList.Name = "rocSSFList";
			this.rocSSFList.PriceSelected = false;
			this.rocSSFList.PriceSSF = 0;
			dgvBasePrinter3.BlackWhite = true;
			dgvBasePrinter3.CellAlignment = System.Drawing.StringAlignment.Near;
			dgvBasePrinter3.CellFormatFlags = ((System.Drawing.StringFormatFlags)((System.Drawing.StringFormatFlags.LineLimit | System.Drawing.StringFormatFlags.NoClip)));
			dgvBasePrinter3.DocName = null;
			dgvBasePrinter3.Footer = null;
			dgvBasePrinter3.FooterAlignment = System.Drawing.StringAlignment.Center;
			dgvBasePrinter3.FooterColor = System.Drawing.Color.Black;
			dgvBasePrinter3.FooterFont = new System.Drawing.Font("Tahoma", 10F, System.Drawing.FontStyle.Bold);
			stringFormat9.Alignment = System.Drawing.StringAlignment.Center;
			stringFormat9.FormatFlags = ((System.Drawing.StringFormatFlags)(((System.Drawing.StringFormatFlags.NoWrap | System.Drawing.StringFormatFlags.LineLimit)
						| System.Drawing.StringFormatFlags.NoClip)));
			...
			stringFormat9.Trimming = System.Drawing.StringTrimming.Word;
			dgvBasePrinter3.FooterFormat = stringFormat9;
			dgvBasePrinter3.FooterFormatFlags = ((System.Drawing.StringFormatFlags)(((System.Drawing.StringFormatFlags.NoWrap | System.Drawing.StringFormatFlags.LineLimit)
						| System.Drawing.StringFormatFlags.NoClip)));
			dgvBasePrinter3.FooterSpacing = 0F;
			dgvBasePrinter3.HeaderCellAlignment = System.Drawing.StringAlignment.Near;
			dgvBasePrinter3.HeaderCellFormatFlags = ((System.Drawing.StringFormatFlags)((System.Drawing.StringFormatFlags.LineLimit | System.Drawing.StringFormatFlags.NoClip)));
			dgvBasePrinter3.Owner = null;
			dgvBasePrinter3.PageNumberAlignment = System.Drawing.StringAlignment.Center;
			dgvBasePrinter3.PageNumberColor = System.Drawing.Color.Black;
			dgvBasePrinter3.PageNumberFont = new System.Drawing.Font("Tahoma", 8F);
			stringFormat10.Alignment = System.Drawing.StringAlignment.Center;
			stringFormat10.FormatFlags = ((System.Drawing.StringFormatFlags)(((System.Drawing.StringFormatFlags.NoWrap | System.Drawing.StringFormatFlags.LineLimit)
						| System.Drawing.StringFormatFlags.NoClip)));
			...
			stringFormat10.Trimming = System.Drawing.StringTrimming.Word;
			dgvBasePrinter3.PageNumberFormat = stringFormat10;
			dgvBasePrinter3.PageNumberFormatFlags = ((System.Drawing.StringFormatFlags)(((System.Drawing.StringFormatFlags.NoWrap | System.Drawing.StringFormatFlags.LineLimit)
						| System.Drawing.StringFormatFlags.NoClip)));
			dgvBasePrinter3.PageNumberInHeader = false;
			dgvBasePrinter3.PageNumberOnSeparateLine = true;
			dgvBasePrinter3.PageNumbers = true;
			dgvBasePrinter3.PageSeparator = " of ";
			dgvBasePrinter3.PageText = "Page ";
			dgvBasePrinter3.PartText = " - Part ";
			dgvBasePrinter3.PorportionalColumns = false;
			dgvBasePrinter3.PreviewDialogIcon = null;
			dgvBasePrinter3.PrinterName = null;
			dgvBasePrinter3.PrintMargins = new System.Drawing.Printing.Margins(60, 60, 40, 40);
			dgvBasePrinter3.PrintPreviewZoom = 1;
			dgvBasePrinter3.ShowTotalPageNumber = true;
			dgvBasePrinter3.SubTitle = null;
			dgvBasePrinter3.SubTitleAlignment = System.Drawing.StringAlignment.Center;
			dgvBasePrinter3.SubTitleColor = System.Drawing.Color.Black;
			dgvBasePrinter3.SubTitleFont = new System.Drawing.Font("Tahoma", 12F, System.Drawing.FontStyle.Bold);
			stringFormat11.Alignment = System.Drawing.StringAlignment.Center;
			stringFormat11.FormatFlags = ((System.Drawing.StringFormatFlags)(((System.Drawing.StringFormatFlags.NoWrap | System.Drawing.StringFormatFlags.LineLimit)
						| System.Drawing.StringFormatFlags.NoClip)));
			...
			stringFormat11.Trimming = System.Drawing.StringTrimming.Word;
			dgvBasePrinter3.SubTitleFormat = stringFormat11;
			dgvBasePrinter3.SubTitleFormatFlags = ((System.Drawing.StringFormatFlags)(((System.Drawing.StringFormatFlags.NoWrap | System.Drawing.StringFormatFlags.LineLimit)
						| System.Drawing.StringFormatFlags.NoClip)));
			dgvBasePrinter3.TableAlignment = DataGridViewEx.DGVBasePrinter.Alignment.NotSet;
			dgvBasePrinter3.Title = null;
			dgvBasePrinter3.TitleAlignment = System.Drawing.StringAlignment.Center;
			dgvBasePrinter3.TitleColor = System.Drawing.Color.Black;
			dgvBasePrinter3.TitleFont = new System.Drawing.Font("Tahoma", 18F, System.Drawing.FontStyle.Bold);
			stringFormat12.Alignment = System.Drawing.StringAlignment.Center;
			stringFormat12.FormatFlags = ((System.Drawing.StringFormatFlags)(((System.Drawing.StringFormatFlags.NoWrap | System.Drawing.StringFormatFlags.LineLimit)
						| System.Drawing.StringFormatFlags.NoClip)));
			...
			stringFormat12.Trimming = System.Drawing.StringTrimming.Word;
			dgvBasePrinter3.TitleFormat = stringFormat12;
			dgvBasePrinter3.TitleFormatFlags = ((System.Drawing.StringFormatFlags)(((System.Drawing.StringFormatFlags.NoWrap | System.Drawing.StringFormatFlags.LineLimit)
						| System.Drawing.StringFormatFlags.NoClip)));
			this.rocSSFList.Printer = dgvBasePrinter3;
			this.rocSSFList.Processing = false;
			this.rocSSFList.RedDefault = 233;
			this.rocSSFList.RefreshAggragation = true;
			this.rocSSFList.RefreshSharedRows = false;
			this.rocSSFList.SecTypeSSF = "";
			this.rocSSFList.SelectedForeColor = System.Drawing.Color.LightBlue;
			this.rocSSFList.ShouldScrollToLastRow = false;
			this.rocSSFList.Size = new System.Drawing.Size(0, 0);
			this.rocSSFList.SizeSelected = false;
			this.rocSSFList.SizeSSF = ((long)(0));
			new BindingListEx.ROCBindingList<string>().Add("");
			this.rocSSFList.SymbolSSF = "";
			this.rocSSFList.TabIndex = 0;
			this.rocSSFList.TabStop = false;
			this.rocSSFList.TickSizes = ((System.Collections.Generic.Dictionary<string, double>)(resources.GetObject("rocSSFList.TickSizes")));
			// 
			// panelCommandsEx
			// 
			...
			this.Caption = "FUTURE TICKET";
			this.ClientSize = new System.Drawing.Size(362, 446);
			this.Controls.Add(this.panelManagerFuture);
			...
			this.MinimumSize = new System.Drawing.Size(369, 454);
			this.Name = "frmFutureTicket";
			...
			this.panelManagerFuture.ResumeLayout(false);
			this.managedPanelBook.ResumeLayout(false);
			this.splitContainerBooks.Panel1.ResumeLayout(false);
			this.splitContainerBooks.Panel2.ResumeLayout(false);
			this.splitContainerBooks.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.rocBookListBid)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.rocBookListAsk)).EndInit();
			this.managedPanelSSF.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.rocSSFList)).EndInit();
		...
		private PanelEx.PanelManager panelManagerFuture;
		private PanelEx.ManagedPanel managedPanelBook;
		private PanelEx.ManagedPanel managedPanelSSF;
		private System.Windows.Forms.SplitContainer splitContainerBooks;
		private DataGridViewEx.ROCBookList rocBookListBid;
		private DataGridViewEx.ROCBookList rocBookListAsk;
		private System.Windows.Forms.ToolStripMenuItem itemResetToSystemDefault;
		private DataGridViewEx.ROCSSFList rocSSFList;
