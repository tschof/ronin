namespace ROC
{
	partial class menuBaseTrades
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(menuBaseTrades));
			...
			this.rocOrderTradesList = new DataGridViewEx.ROCSubTradesList();
			((System.ComponentModel.ISupportInitialize)(this.rocOrderTradesList)).BeginInit();
			this.SuspendLayout();
			// 
			// rocOrderTradesList
			// 
			this.rocOrderTradesList.BlueDefault = 228;
			this.rocOrderTradesList.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			new BindingListEx.ROCBindingList<string>().Add("");
			this.rocOrderTradesList.DisplayFactors = ((System.Collections.Generic.Dictionary<string, double>)(resources.GetObject("rocOrderTradesList.DisplayFactors")));
			this.rocOrderTradesList.Dock = System.Windows.Forms.DockStyle.Fill;
			this.rocOrderTradesList.GreenDefault = 243;
			this.rocOrderTradesList.GridKeys = ((System.Collections.Generic.List<string>)(resources.GetObject("rocOrderTradesList.GridKeys")));
			this.rocOrderTradesList.HeaderBackColor = System.Drawing.Color.FromArgb(((int)(((byte)(233)))), ((int)(((byte)(243)))), ((int)(((byte)(228)))));
			this.rocOrderTradesList.Importing = false;
			this.rocOrderTradesList.LastFilter = "";
			this.rocOrderTradesList.LastSort = "";
			this.rocOrderTradesList.Location = new System.Drawing.Point(2, 2);
			this.rocOrderTradesList.Name = "rocOrderTradesList";
			...
			dgvBasePrinter1.TitleFormatFlags = ((System.Drawing.StringFormatFlags)(((System.Drawing.StringFormatFlags.NoWrap | System.Drawing.StringFormatFlags.LineLimit)
						| System.Drawing.StringFormatFlags.NoClip)));
			this.rocOrderTradesList.Printer = dgvBasePrinter1;
			this.rocOrderTradesList.Processing = false;
			this.rocOrderTradesList.RedDefault = 233;
			this.rocOrderTradesList.RefreshAggragation = true;
			this.rocOrderTradesList.RefreshSharedRows = false;
			this.rocOrderTradesList.ShouldScrollToLastRow = false;
			this.rocOrderTradesList.Size = new System.Drawing.Size(276, 61);
			new BindingListEx.ROCBindingList<string>().Add("");
			this.rocOrderTradesList.TabIndex = 0;
			this.rocOrderTradesList.TickSizes = ((System.Collections.Generic.Dictionary<string, double>)(resources.GetObject("rocOrderTradesList.TickSizes")));
			// 
			// menuBaseTrades
			// 
			...
			this.Controls.Add(this.rocOrderTradesList);
			this.DoubleBuffered = true;
			this.ForeColor = System.Drawing.Color.White;
			this.MaximumSize = new System.Drawing.Size(500, 500);
			this.MinimumSize = new System.Drawing.Size(280, 65);
			this.Name = "menuBaseTrades";
			this.Padding = new System.Windows.Forms.Padding(2);
			this.Size = new System.Drawing.Size(280, 65);
			this.Load += new System.EventHandler(this.menuOrderTrades_Load);
			((System.ComponentModel.ISupportInitialize)(this.rocOrderTradesList)).EndInit();
		...
		private DataGridViewEx.ROCSubTradesList rocOrderTradesList;
