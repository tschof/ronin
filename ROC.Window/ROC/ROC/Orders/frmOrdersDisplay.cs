...
namespace ROC
{
	...
	public partial class frmOrdersDisplay : VistaWindowBorderless, INotifyPropertyChanged
	{
		...
		public frmOrdersDisplay(ROCOrderProfile prof)
		{
			InitializeComponent();
			...
			itemColumnAlgoType.ItemColor = prof.ProfileColumns["AlgoType"].ColumnForeColor;
			...
			itemColumnParentTag.ItemColor = prof.ProfileColumns["ParentTag"].ColumnForeColor;
			itemColumnEcho.ItemColor = prof.ProfileColumns["Echo"].ColumnForeColor;
		...
		public ROCOrderProfile GetProfile(ROCOrderProfile prof)
		{
			...
			prof.ProfileColumns["AlgoType"].ColumnForeColor = itemColumnAlgoType.ItemColor;
			...
			prof.ProfileColumns["ParentTag"].ColumnForeColor = itemColumnParentTag.ItemColor;
			prof.ProfileColumns["Echo"].ColumnForeColor = itemColumnEcho.ItemColor;
		...
		private void cmdDefaultColor_Click(object sender, EventArgs e)
		{
			...
			itemColumnAlgoType.ItemColor = itemColorText.ItemColor;
			...
			itemColumnParentTag.ItemColor = itemColorText.ItemColor;
			itemColumnEcho.ItemColor = itemColorText.ItemColor;
		}
