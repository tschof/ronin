namespace ROC
{
	partial class frmOrdersDisplay
	{
		...
		private void InitializeComponent()
		{
			...
			this.itemColumnEcho = new ROC.itemBaseColor();
			this.itemColumnParentTag = new ROC.itemBaseColor();
			...
			this.itemColumnAlgoType = new ROC.itemBaseColor();
			this.itemColumnDuration = new ROC.itemBaseColor();
			this.itemColumnType = new ROC.itemBaseColor();
			this.itemColumnAvgPrice = new ROC.itemBaseColor();
			this.itemColumnFilledQty = new ROC.itemBaseColor();
			this.itemColumnPrice = new ROC.itemBaseColor();
			this.itemColumnLeaveQty = new ROC.itemBaseColor();
			this.itemColumnQty = new ROC.itemBaseColor();
			this.itemColumnSymbol = new ROC.itemBaseColor();
			this.itemColumnOrderID = new ROC.itemBaseColor();
			...
			this.itemStatusOther = new ROC.itemBaseColor();
			this.itemStatusReplacePending = new ROC.itemBaseColor();
			this.itemStatusReplaceRejected = new ROC.itemBaseColor();
			this.itemStatusBusted = new ROC.itemBaseColor();
			this.itemStatusCorrected = new ROC.itemBaseColor();
			this.itemStatusCancelRejected = new ROC.itemBaseColor();
			this.itemStatusExpired = new ROC.itemBaseColor();
			this.itemStatusCalculated = new ROC.itemBaseColor();
			this.itemStatusStopped = new ROC.itemBaseColor();
			this.itemStatusPendingCancel = new ROC.itemBaseColor();
			this.itemStatusDoneForDay = new ROC.itemBaseColor();
			this.itemStatusRejected = new ROC.itemBaseColor();
			this.itemStatusCancelled = new ROC.itemBaseColor();
			this.itemStatusReplaced = new ROC.itemBaseColor();
			this.itemStatusFilled = new ROC.itemBaseColor();
			this.itemStatusPartialFilled = new ROC.itemBaseColor();
			this.itemStatusOpen = new ROC.itemBaseColor();
			...
			// grpColumn
			// 
			this.grpColumn.Controls.Add(this.itemColumnEcho);
			this.grpColumn.Controls.Add(this.itemColumnParentTag);
			...
			this.grpColumn.Controls.Add(this.itemColumnAlgoType);
			...
			// itemColumnEcho
			// 
			this.itemColumnEcho.BackColor = System.Drawing.Color.Black;
			this.itemColumnEcho.Dock = System.Windows.Forms.DockStyle.Top;
			this.itemColumnEcho.ForeColor = System.Drawing.Color.White;
			this.itemColumnEcho.ItemColor = System.Drawing.Color.Black;
			this.itemColumnEcho.ItemName = "Echo";
			this.itemColumnEcho.Location = new System.Drawing.Point(3, 400);
			this.itemColumnEcho.Name = "itemColumnEcho";
			this.itemColumnEcho.Padding = new System.Windows.Forms.Padding(2);
			this.itemColumnEcho.Size = new System.Drawing.Size(127, 24);
			this.itemColumnEcho.TabIndex = 45;
			// 
			// itemColumnParentTag
			// 
			this.itemColumnParentTag.BackColor = System.Drawing.Color.Black;
			this.itemColumnParentTag.Dock = System.Windows.Forms.DockStyle.Top;
			this.itemColumnParentTag.ForeColor = System.Drawing.Color.White;
			this.itemColumnParentTag.ItemColor = System.Drawing.Color.Black;
			this.itemColumnParentTag.ItemName = "PTag";
			this.itemColumnParentTag.Location = new System.Drawing.Point(3, 376);
			this.itemColumnParentTag.Name = "itemColumnParentTag";
			this.itemColumnParentTag.Padding = new System.Windows.Forms.Padding(2);
			this.itemColumnParentTag.Size = new System.Drawing.Size(127, 24);
			this.itemColumnParentTag.TabIndex = 44;
			// 
			// itemColumnAccount
			// 
			...
			this.itemColumnAccount.Location = new System.Drawing.Point(3, 352);
			...
			this.itemColumnTime.Location = new System.Drawing.Point(3, 328);
			...
			this.itemColumnExchange.Location = new System.Drawing.Point(3, 304);
			...
			// itemColumnAlgoType
			// 
			this.itemColumnAlgoType.BackColor = System.Drawing.Color.Black;
			this.itemColumnAlgoType.Dock = System.Windows.Forms.DockStyle.Top;
			this.itemColumnAlgoType.ForeColor = System.Drawing.Color.White;
			this.itemColumnAlgoType.ItemColor = System.Drawing.Color.Black;
			this.itemColumnAlgoType.ItemName = "Algo Type";
			this.itemColumnAlgoType.Location = new System.Drawing.Point(3, 280);
			this.itemColumnAlgoType.Name = "itemColumnAlgoType";
			this.itemColumnAlgoType.Padding = new System.Windows.Forms.Padding(2);
			this.itemColumnAlgoType.Size = new System.Drawing.Size(127, 24);
			this.itemColumnAlgoType.TabIndex = 43;
			// 
			// itemColumnDuration
			// 
			...
			this.itemColumnDuration.Location = new System.Drawing.Point(3, 256);
			...
			this.itemColumnType.Location = new System.Drawing.Point(3, 232);
			...
			this.itemColumnAvgPrice.Location = new System.Drawing.Point(3, 208);
			...
			this.itemColumnFilledQty.Location = new System.Drawing.Point(3, 184);
			...
			this.itemColumnPrice.Location = new System.Drawing.Point(3, 160);
			...
			this.itemColumnLeaveQty.Location = new System.Drawing.Point(3, 136);
			...
			this.itemColumnDisplay.TabIndex = 46;
			// 
			// frmOrdersDisplay
			// 
		...
		public itemBaseColor itemColumnDuration;
		public itemBaseColor itemColumnType;
		public itemBaseColor itemColumnAvgPrice;
		public itemBaseColor itemColumnFilledQty;
		public itemBaseColor itemColumnPrice;
		public itemBaseColor itemColumnLeaveQty;
		public itemBaseColor itemColumnQty;
		public itemBaseColor itemColumnSymbol;
		public itemBaseColor itemColumnOrderID;
		...
		public itemBaseColor itemStatusOther;
		public itemBaseColor itemStatusReplacePending;
		public itemBaseColor itemStatusReplaceRejected;
		public itemBaseColor itemStatusBusted;
		public itemBaseColor itemStatusCorrected;
		public itemBaseColor itemStatusCancelRejected;
		public itemBaseColor itemStatusExpired;
		public itemBaseColor itemStatusCalculated;
		public itemBaseColor itemStatusStopped;
		public itemBaseColor itemStatusPendingCancel;
		public itemBaseColor itemStatusDoneForDay;
		public itemBaseColor itemStatusRejected;
		public itemBaseColor itemStatusCancelled;
		public itemBaseColor itemStatusReplaced;
		public itemBaseColor itemStatusFilled;
		public itemBaseColor itemStatusPartialFilled;
		public itemBaseColor itemStatusOpen;
		...
		public itemBaseColor itemColumnAlgoType;
		public itemBaseColor itemColumnEcho;
		public itemBaseColor itemColumnParentTag;
