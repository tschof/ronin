...
namespace ThreadEx
{
	...
	public sealed class ThreadPoolEx : WaitHandle
	{
		#region - ThreadPool constructors -

		public ThreadPoolEx(int initialThreadCount, int maxThreadCount, string poolName)
		...
		class ThreadWrapper
		{
			...
			public ThreadWrapper(ThreadPoolEx pool, bool isPermanent,
