...
namespace LabelEx
{
	...
	public class VistaLabel : Label
	{
		...
		private void DrawForegroundFromLabel(PaintEventArgs pevent)
		{
			...
			if (_imageLabel.Image != Image && _imageLabel.Image != null)
			{
		...
		[DefaultValue(typeof(LabelEx.VistaLabel.Shapes), "RoundRectangle"), Category("Appearance"), Description("Indicates whether the control shape.")]
