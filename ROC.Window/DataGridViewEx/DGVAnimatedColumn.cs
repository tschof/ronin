...
{
	public class DGVAnimatedColumn : DataGridViewColumn
	{
		public DGVAnimatedColumn()
		{
			base.CellTemplate = new DGVAnimatedCell();
		}
		...
		private NotifyTypes _notifyType = NotifyTypes.None;
		[DefaultValue(typeof(DataGridViewEx.NotifyTypes), "None"), Category("Appearance"), Description("The notify type, border, background or foreground")]
