...
namespace DataGridViewEx
{
	...
	public class DGVColumnProfile : MutiTypedUIDictionary
	{
		...
		public Color NotifyPositiveColor
		{
			get
			{
				if (Colors.ContainsKey(DGVColumnProfileFieldID.Notify.NotifyPositiveColor))
				{
					return Colors[DGVColumnProfileFieldID.Notify.NotifyPositiveColor];
				}
				else
				{
		...
		public float NotifyPositiveBorderWidth
		{
			get
			{
				if (Doubles.ContainsKey(DGVColumnProfileFieldID.Notify.NotifyPositiveBorderWidth))
				{
					return (float)Doubles[DGVColumnProfileFieldID.Notify.NotifyPositiveBorderWidth];
				}
				else
				{
					return 1.5f;
		...
		public Color NotifyNegativeColor
		{
			get
			{
				if (Colors.ContainsKey(DGVColumnProfileFieldID.Notify.NotifyNegativeColor))
				{
					return Colors[DGVColumnProfileFieldID.Notify.NotifyNegativeColor];
				}
				else
				{
					return Color.Red;
		...
		public float NotifyNegativeBorderWidth
		{
			get
			{
				if (Doubles.ContainsKey(DGVColumnProfileFieldID.Notify.NotifyNegativeBorderWidth))
				{
					return (float)Doubles[DGVColumnProfileFieldID.Notify.NotifyNegativeBorderWidth];
				}
				else
				{
					return 1.5f;
