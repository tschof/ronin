...
{
	public class DGVNumberColumn : DataGridViewColumn
	{
		public DGVNumberColumn()
		{
			base.CellTemplate = new DGVNumberCell();
		}
		...
		[DefaultValue(typeof(int), "7"), Category("Appearance"), Description("The max decimal to show")]
		...
		[DefaultValue(typeof(double), "1"), Category("Appearance"), Description("The display factor of the cell")]
		...
		[DefaultValue(typeof(double), "0.01"), Category("Appearance"), Description("The tick size of the cell")]
		...
		[DefaultValue(typeof(bool), "false"), Category("Appearance"), Description("The cell is a percent value or not")]
		...
		[DefaultValue(typeof(bool), "false"), Category("Appearance"), Description("Show call value as fraction or not")]
