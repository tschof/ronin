...
{
    public class DGVBaseNumericUpDownCell : DataGridViewTextBoxCell
    {
        ...
        private static Type defaultEditType = typeof(DGVBaseNumericUpDownEditingControl);
		...
		public DGVBaseNumericUpDownCell()
        {
        ...
        private DGVBaseNumericUpDownEditingControl EditingNumericUpDown
        {
            get
            {
                return this.DataGridView.EditingControl as DGVBaseNumericUpDownEditingControl;
            }
        }
        ...
        public override Type EditType
        {
            get
            {
                return defaultEditType; // the type is DGVBaseNumericUpDownEditingControl
            }
        }
        ...
        {
            DGVBaseNumericUpDownCell dataGridViewCell = base.Clone() as DGVBaseNumericUpDownCell;
        ...
        private bool OwnsEditingNumericUpDown(int rowIndex)
        {
            ...
            DGVBaseNumericUpDownEditingControl numericUpDownEditingControl = this.DataGridView.EditingControl as DGVBaseNumericUpDownEditingControl;
                                      ...
                                      DataGridViewAdvancedBorderStyle advancedBorderStyle, DataGridViewPaintParts paintParts)
        {
            ...
            if (!cellEdited)
            {
                if (PartPainted(paintParts, DataGridViewPaintParts.ContentForeground))
                {
                    ...
                    paintingNumericUpDown.TextAlign = DGVBaseNumericUpDownCell.TranslateAlignment(cellStyle.Alignment);
        ...
        {
            return "DGVBaseNumericUpDownCell { ColumnIndex=" + ColumnIndex.ToString(CultureInfo.CurrentCulture) + ", RowIndex=" + RowIndex.ToString(CultureInfo.CurrentCulture) + " }";
        }
