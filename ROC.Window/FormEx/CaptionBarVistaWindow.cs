...
{
	[ToolboxItem(true)]
	public partial class CaptionBarVistaWindow : UserControl
	{
		...
		private sealed class FormIcons
		{
			public const int DEFAULT = 0;
			public const int LOGIN = 1;
		}

		public CaptionBarVistaWindow()
		{
			InitializeComponent();
		}
		...
		{
			CaptionBarVistaWindow control = (CaptionBarVistaWindow)sender;
		...
		private void VistaWindowCaptionBar_MouseEnter(object sender, EventArgs e)
		{
			if (_form != null)
			{
				_form.Activate();
		...
		private void lblCaption_MouseDown(object sender, MouseEventArgs e)
		{
			if (_form != null)
			{
				if (e.Clicks <= 1)
				{
					...
					DockWindowHelper.SendMessage(_form.Handle, DockWindowHelper.WM_NCLBUTTONDOWN, DockWindowHelper.HTCAPTION, (int)lParam);
				}
				else
				{
