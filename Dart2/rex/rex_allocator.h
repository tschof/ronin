 ...
 * All Rights Reserved
 *************************************************************************/
#ifndef _REX_ALLOCATOR_H__
#define _REX_ALLOCATOR_H__
...
#define REX_PG_SIZE 4096

unsigned int next_power_of_two(unsigned int size);
typedef struct rex_mem_glob dallocator;
/**
...
#define REX_ALLOC(data,alignment, size, alloc_ret)                    \
