...
/**
 * Copies the values from the char* into the dart order obj.
 * This is a heavy weight operation and is usually done off thread 
 ...
 */
void set_fix_val(ofp* doj, int offset, char* val, int val_len);
/**
 ...
 */
void set_num_val(ofp* doj, int fix_tag, unsigned int value);
/**
 ...
 * ofp object's message.
 */
void add_num_val(ofp* doj, int fix_tag, unsigned int value);
/**
 * This function acts much like the above set_num_val except it blindly appends
 * the fix_tag and value to the current end of the ofp message.
 * @see set_num_val()
 ...
 * timestamp.
 */
void set_time_tag(ofp* obj, struct tm *timeval, int offset);
/**
 ...
 * @param offset the integer representation of the FIX tag you wish to associate with this
 */
void add_time_tag(ofp* obj, struct tm *timeval, int offset);
