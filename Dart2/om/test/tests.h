...
DECLARE_TEST(test_reset_calculator)
    ...
    DECLARE_TEST(test_ise_parent_mngt)
    DECLARE_TEST(test_ise_parent_mngt_replace)
    DECLARE_TEST(test_ise_parent_mngt_replace_partials)
    DECLARE_TEST(test_cme_logon)
